# Awesome Mobile Apps that Connect to Nextcloud [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

## Motivation

A lot of iOS and Android applications sync to cloud services like Dropbox, iCloud, or the Google Services. Here we collect a curated list of awesome iOS and Android apps able to interface with Nextcloud (or Owncloud). Feel free to contribute.
